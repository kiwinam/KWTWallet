...
public class KeyStoreUtils {
    ...
    public static String genKeyStoreToFiles(ECKeyPair ecKeyPair, Context context){
        try{
            ...
            Log.e("generate Wallet File", fileName);
            Log.e("generate Wallet address", address);
            return address;
    ...
    public static String signedTransactionData(Context context,String from, String to, String nonce, String gasPrice, String gasLimit, String value) throws FileNotFoundException{
        ...
        Credentials credentials = KeyStoreUtils.getCredentials(from,context);
