package wallet.kiwinam.charlie.kwtwallet.contract;
 ...
 */
public class KiwiTestToken extends Contract {
    public static final String CONTRACT_ADDRESS = "0x7FA51E096a26fBa76212c1451Abd28BF90330E07"; // KiwiTestToken 계약서 주소
    public static final String OWNER_ADDRESS = "0x452b750ee42de5b6241d3d23f3d2029ad4314dcb"; // KiwiTestToken 오너 주소 ( 여우 지갑 Charlie )
    ...
    public KiwiTestToken(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    protected KiwiTestToken(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
    ...
    public static RemoteCall<KiwiTestToken> deploy(Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(KiwiTestToken.class, web3j, credentials, gasPrice, gasLimit, BINARY, "");
    }

    public static RemoteCall<KiwiTestToken> deploy(Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(KiwiTestToken.class, web3j, transactionManager, gasPrice, gasLimit, BINARY, "");
    }
    ...
    public static KiwiTestToken load(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new KiwiTestToken(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    public static KiwiTestToken load(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new KiwiTestToken(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }
